...
const TDatePicker = forwardRef(({},ref) => {
...
const TTimePicker = forwardRef(({},ref) => {
  ...
  return (
    <div className="flex flex-col items-start space-y-4 p-4">
      ...
      <DatePicker
        ...
        required
        className="w-full placeholder-custom-c4 text-sm bg-custom-c1 py-4 border border-custom-c4 rounded-sm focus:custom-c2 focus:custom-c2 focus:custom-c2 focus:custom-c2 text-custom-c4"
      />
    </div>
  );
});
