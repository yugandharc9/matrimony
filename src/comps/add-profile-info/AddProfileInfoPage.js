            ...
            <form ref={formRef} onSubmit={handleSubmit}>
                <div className="h-screen bg-custom-c1">
                    <div className='flex flex-col bg-custom-c1 items-center justify-between gap-y-5 overflow-auto'>
                        ...
                        <hr className="w-4/5 h-2 border-custom-c2" />
                        <div className="grid grid-cols-2 gap-5 w-2/3 ">
                            < Input placeholder="Birth Date" ref={birthdate} className="label-right" defaultValue="" isRequired={true} type="date" labelName="Birth Date" />
                            < Input placeholder="Birth Time" ref={birthtime} isRequired={true} type="time" labelName="Birth Time" />
                        </div>
                        <div className="grid grid-cols-2 gap-5 w-2/3 ">
                        ...
                        />
                        <Button ref={btnRef} type="submit" onClick={handleButtonClick} name="Save" />
                    </div>
                </div>
            </form>
        </>
